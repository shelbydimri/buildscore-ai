  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <p className="text-xs text-slate-500 text-center">
        Analysis typically takes 8–10 minutes. We&apos;ll use advanced AI agents to validate your idea against market data, competitive landscape, and user demand signals.
      </p>
    </form>
  );
}
